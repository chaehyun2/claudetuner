...
const TRANSLATIONS = {
  ko: {
    ...
    'show_runner_desc': '러너 애니메이션 표시',
    'show_runner_hint': '팝업 위쪽에서 이모지가 사용 속도에 따라 움직입니다. 끄면 움직이지 않고 고정됩니다. 시스템의 「동작 줄이기」 설정이 켜져 있으면 기본으로 꺼집니다.',
    'runner_pause': '애니메이션 멈추기',
    'runner_resume': '애니메이션 다시 켜기',
    'reset': '리셋',
    'team_no_7d': 'Team 플랜: 7일 한도 없음',
    'free_no_7d': 'Free 플랜: 7일 사용률 제공 안 됨',
    'usage_withheld': 'Claude가 이 계정의 사용률을 제공하지 않습니다',
    'usage_withheld_plan': 'Claude가 {0} 플랜에 사용률을 제공하지 않습니다',
    ...
    // #1176 — 종전엔 이 셋이 전부 「수집 실패」 한 문장이었다. 사용자가 할 일이 다르므로 갈라 둔다.
    'err_tab_no_result': 'Claude.ai 탭에서 응답을 받지 못했습니다. 탭을 열어두거나 새로고침해주세요.',
    'err_fallback_exhausted': 'Claude.ai에 접근하지 못했습니다. Claude.ai 탭을 열어두거나 다시 로그인해주세요.',
    'err_unclassified': '수집 중 문제가 발생했습니다. 계속되면 문의해주세요.',
    ...
    'sign_out': '로그아웃',
    // Options page structure (#1719 ⑤): TOC / group headings and the new card labels.
    'grp_account': '계정·상태',
    'grp_collect': '수집',
    'grp_display': '화면',
    'grp_sites': '사이트 안 표시',
    'grp_notify': '알림',
    'grp_advanced': '고급',
    'appearance_title': '테마·언어·표시 방식',
    'status_service': '서비스',
    'page_usage_col_sidebar': '사이드바',
    'page_usage_col_input': '입력줄',
    'page_usage_col_folders': '폴더',
    'data_reset_title': '데이터 초기화',
  },
  en: {
    ...
    'show_runner_desc': 'Show runner animation',
    'show_runner_hint': 'The emoji near the top of the popup moves with how fast you are using your limit. Turn this off to keep it still. It is off by default when your system has "reduce motion" turned on.',
    'runner_pause': 'Stop animation',
    'runner_resume': 'Resume animation',
    'reset': 'Reset',
    'team_no_7d': 'Team plan: no 7-day limit',
    'free_no_7d': 'Free plan: 7-day usage not available',
    'usage_withheld': "Claude isn't providing usage for this account",
    'usage_withheld_plan': "Claude isn't providing usage on the {0} plan",
    ...
    'err_tab_no_result': 'No response from the Claude.ai tab. Please open or refresh it.',
    'err_fallback_exhausted': "Couldn't reach Claude.ai. Please keep a Claude.ai tab open or sign in again.",
    'err_unclassified': 'Something went wrong while collecting. Please contact us if it keeps happening.',
    ...
    'sign_out': 'Sign out',
    // Options page structure (#1719 ⑤): TOC / group headings and the new card labels.
    'grp_account': 'Account & status',
    'grp_collect': 'Collection',
    'grp_display': 'Display',
    'grp_sites': 'On-site display',
    'grp_notify': 'Notifications',
    'grp_advanced': 'Advanced',
    'appearance_title': 'Theme, language & display mode',
    'status_service': 'Service',
    'page_usage_col_sidebar': 'Sidebar',
    'page_usage_col_input': 'Input bar',
    'page_usage_col_folders': 'Folders',
    'data_reset_title': 'Reset local data',
  },
};
