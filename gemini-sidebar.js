...
(() => {
  ...
  function renderPanelBody() {
    ...
    footer.innerHTML = `
      ...
      <span class="ct-gm-actions">
        ...
        <a class="ct-gm-link" href="${SITE_URL}/dashboard/?utm_source=${UTM}" target="_blank" rel="noopener" title="${CORE.escapeHtml(t('dashboard'))}">
  ...
  function onStorageChanged(changes, area) {
    ...
    if (area === 'local' && changes.ct_entitlement) { fetchAds(); return; }
    if (area !== 'sync') return;
