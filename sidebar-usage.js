  ...
  function renderPanelBody() {
    ...
    actions.innerHTML = `
      <button class="ct-sb-bell-btn" title="${t('notices')}">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="text-text-500">
          <path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/>
          <path d="M13.73 21a2 2 0 01-3.46 0"/>
        </svg>
        <span class="ct-sb-bell-badge" id="ct-sb-bell-badge" style="display:none"></span>
      </button>
      <a class="ct-sb-link" href="${SITE_URL}/dashboard/" target="_blank" rel="noopener" title="${t('dashboard')}">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="text-text-500">
